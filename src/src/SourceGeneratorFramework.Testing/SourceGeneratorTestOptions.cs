...
public record SourceGeneratorTestOptions
{
	...
	/// <summary>
	/// Gets additional generator types to run alongside the primary generator in a single compiler pass. Used
	/// when a generator depends on the output of another generator (for example the
	/// <c>AttributeDataModelGenerator</c> reading type-library constants generated by the
	/// <c>TypeLibraryGenerator</c> in the same pass).
	/// </summary>
	public ImmutableArray<Type> AdditionalGeneratorTypes { get; init; } = [];
